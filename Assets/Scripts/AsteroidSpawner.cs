...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    public int allAsteroidsCount = 0;

    private int currentAllAsteroids = 0;
    ...
    IEnumerator CreateAsteroids()
    {
        ...
        while (true)
        {
            if (currentAllAsteroids == allAsteroidsCount)
            {
    ...
    void CreateNewAsteroid()
    {
       ...
       // var positionArr = new Vector3[] { new Vector3(-1.0f, 1.0f, - 1.0f), new Vector3(1.0f, 1.0f, -1.0f), new Vector3(-1.0f, 1.0f, 1.0f), new Vector3(1.0f, 1.0f, 1.0f) };
        //var positionValue = positionArr[Random.Range(positionArr.Length, positionArr.Length)];
